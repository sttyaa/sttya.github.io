      ...
      <div class="card-body">
        ...
        <form action="" method="post">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" name="nik" id="nik" class="form-control shadow-sm" value="<?php echo $nik ?>">
            </div>
          </div>
          <!-- Nama Lengkap -->
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <textarea class="form-control shadow-sm" name="alamat" id="alamat" rows="3" value="<?php echo $alamat ?>"></textarea>
            </div>
          </div>
          <!-- Button -->
